...
import { getFormSubmissions } from "../services/sightingsApi";

export const SightingsComponent = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Sightings Hatası:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-800 mb-2">👀 Sightings</h2>
