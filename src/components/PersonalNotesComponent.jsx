...
import { getFormSubmissions } from "../services/personalNotesApi";

export const PersonalNotesComponent = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Personal Notes Hatası:", err);
      } finally {
        setLoading(false);
      }
    };
        ...
        {submissions.length > 0 ? (
          submissions.map((submission, idx) => (
            <div
              ...
              className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 border-l-4 border-purple-500"
            >
              {/* Card Header */}
